        ...
        private void VerificarSituacao()
        {
            ...
            try
            {
                ...
                if (Tabela.Rows.Count > 0)
                {
                    ...
                    MessageBox.Show("O cliente selecionado tem uma conta pendente realizada no dia: " + dataVenda + " que vence(u) no dia: " + vencimento, "Caixa Fácil", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                }
            }
            catch (Exception ex)
            {
